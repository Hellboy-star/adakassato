                        ...
                        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1 ">
                            <div class="register-card">
                                ...
                                <form class="register-form" method="post" action="{{route('register')}}">
                                    ...
                                    <div class="row mb-3">
                                        <label for="name" class=" col-form-label text-md-end">Nom d'utilisateur:</label>
                                    ...
                                    <div class="row mb-3">
                                        <label for="password-confirm" class=" col-form-label text-md-end">Confirmer mot de passe:</label>
